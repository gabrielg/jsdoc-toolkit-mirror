 ...
 * @version 0.6b
 * @revision $Id: JsDoc.js 341 2007-05-27 00:53:11Z micmath $
...
/**
 * Print informative message to stdout.
 * @function inform
 * @param {string} msg
 */
//function inform(msg) {
...
Symbol.prototype.getDescription = function() {
	...
	if (descriptions.length) {
		...
		var projectDescriptions = this.doc.getTag("projectdescription");
		if (projectDescriptions.length) return projectDescriptions[0].desc
	}
}
